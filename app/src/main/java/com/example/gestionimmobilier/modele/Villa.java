...
public class Villa {
    ...
    public Villa(int id, String nom, String adresse, String descriptionV, String descriptionP, String superficie, int anneeConstru, float caution, int idTypeVilla) {
        this.id = id;
        this.nom = nom;
    ...
    public Villa(String nom, String adresse, String descriptionV, String descriptionP, String superficie, int anneeConstru, float caution) {
        this.nom = nom;
        this.adresse = adresse;
        this.descriptionV = descriptionV;
        this.descriptionP = descriptionP;
    ...
    public int getIdTypeVilla() {
        return idTypeVilla;
    }

    public void setIdTypeVilla(int idTypeVilla) {
        this.idTypeVilla = idTypeVilla;
    }
