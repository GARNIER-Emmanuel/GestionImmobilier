...
public class VillaDAO {
    ...
    public Villa recupVillaId(int id) {
        ...
        if(curseur.getCount()>0){
            ...
            uneVilla=new Villa(idV, nomV, adresse, descriptionV, descriptionP, superficie, anneesConstruction, caution, idTypeVilla);
    ...
    public int dernierId() {
        Cursor curseur;
        curseur = accesBD.getReadableDatabase().rawQuery("select max(id)+1 from Villa", null);
        curseur.moveToFirst();
    ...
    public Villa getVilla(int id) {
        ...
        if (curseur.getCount() > 0) {
            curseur.moveToFirst();
            laVilla = new Villa(id, curseur.getString(1), curseur.getString(2), curseur.getString(3), curseur.getString(4), curseur.getString(5), curseur.getInt(6), curseur.getFloat(7), curseur.getInt(8));
